...
import com.lemonqwest.app.presentation.theme.components.CircularTaskItem
import com.lemonqwest.app.presentation.theme.components.DailyProgressSummary
import com.lemonqwest.app.presentation.theme.components.PositiveFeedbackAnimation
import com.lemonqwest.app.presentation.theme.components.VisualProgressIndicator
import com.lemonqwest.app.presentation.viewmodels.TaskManagementUiState
...
fun EnhancedChildTaskScreen(
    ...
    var lastCompletedCount by remember { mutableIntStateOf(completedTasks.size) }
