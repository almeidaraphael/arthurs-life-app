...
data class MainContentParams(
    ...
    val theme: com.lemonqwest.app.presentation.theme.BaseAppTheme,
    val uiState: com.lemonqwest.app.presentation.viewmodels.OnboardingUiState,
...
private fun ExistingChildCard(
    child: com.lemonqwest.app.presentation.viewmodels.ChildSetupData,
    onRemove: () -> Unit,
) {
    val theme = LocalBaseTheme.current
