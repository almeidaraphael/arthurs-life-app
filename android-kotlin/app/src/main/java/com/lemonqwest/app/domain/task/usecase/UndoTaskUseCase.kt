...
/**
 * Use case for undoing task completion in LemonQwest MVP.
 *
...
constructor(
    ...
    private fun validateUndoAuthorization(
        currentUser: com.lemonqwest.app.domain.user.User,
        task: com.lemonqwest.app.domain.task.Task,
    ...
    private fun deductTokensFromUser(
        user: com.lemonqwest.app.domain.user.User,
        tokensToDeduct: Int,
    ): com.lemonqwest.app.domain.user.User {
        return user.copy(
