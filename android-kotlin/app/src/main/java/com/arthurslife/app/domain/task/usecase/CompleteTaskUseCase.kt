...
/**
 * Use case for completing tasks and awarding tokens in Arthur's Life MVP.
 *
...
data class TaskCompletionResult(
    ...
    val newlyUnlockedAchievements: List<com.arthurslife.app.domain.achievement.Achievement> = emptyList(),
)
