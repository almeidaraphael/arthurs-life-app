...
import com.arthurslife.app.presentation.theme.components.themeAwareRewardCategoryFilter
import com.arthurslife.app.presentation.theme.components.themeAwareTextButton
import com.arthurslife.app.presentation.viewmodels.RewardManagementViewModel
...
private data class RewardListData(
    ...
    val rewardStats: com.arthurslife.app.domain.reward.usecase.RewardStats?,
...
private fun caregiverRewardManagementContent(
    currentTheme: BaseAppTheme,
    uiState: com.arthurslife.app.presentation.viewmodels.RewardManagementUiState,
    rewardData: RewardListData,
    actions: RewardActions,
    paddingValues: PaddingValues,
) {
...
private fun LazyListScope.statisticsSection(
    currentTheme: BaseAppTheme,
    stats: com.arthurslife.app.domain.reward.usecase.RewardStats,
) {
    item {
        ThemeAwareCard(
            theme = currentTheme,
