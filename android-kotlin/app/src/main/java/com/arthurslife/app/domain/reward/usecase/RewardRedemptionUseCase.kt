package com.arthurslife.app.domain.reward.usecase
...
import com.arthurslife.app.domain.reward.InsufficientTokensException
import com.arthurslife.app.domain.reward.RewardNotFoundException
import com.arthurslife.app.domain.reward.RewardRepository
import com.arthurslife.app.domain.reward.RewardRepositoryException
import com.arthurslife.app.domain.reward.RewardRequiresApprovalException
import com.arthurslife.app.domain.reward.RewardUnavailableException
import com.arthurslife.app.domain.reward.RewardUserNotFoundException
...
constructor(
    ...
    suspend fun getRedeemableRewards(
        userId: String,
    ): Result<List<com.arthurslife.app.domain.reward.Reward>> {
        return try {
            val user = userRepository.findById(userId)
                ?: return Result.failure(RewardUserNotFoundException(userId))
     ...
     */
    suspend fun getApprovalRequiredRewards(): Result<List<com.arthurslife.app.domain.reward.Reward>> {
        return try {
