...
import com.arthurslife.app.presentation.theme.ThemeErrorEvent
...
private fun handleErrorAction(
    ...
    when (errorEvent.type) {
        com.arthurslife.app.presentation.theme.ThemeErrorType.LOAD_FAILED -> {
            onRetryThemeLoad?.invoke()
        }
        com.arthurslife.app.presentation.theme.ThemeErrorType.SAVE_FAILED -> {
            onRetryThemeSave?.invoke()
        }
        com.arthurslife.app.presentation.theme.ThemeErrorType.VALIDATION_FAILED -> {
            // Could open accessibility information dialog
            // For now, just dismiss
        }
        com.arthurslife.app.presentation.theme.ThemeErrorType.GENERIC -> {
