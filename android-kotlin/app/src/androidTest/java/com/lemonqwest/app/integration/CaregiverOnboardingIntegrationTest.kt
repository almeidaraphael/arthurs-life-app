...
import com.lemonqwest.app.testutils.DataConsistencyTestUtils
...
/**
 * Integration tests for caregiver onboarding workflow with complete test isolation.
 *
 ...
 */
class CaregiverOnboardingIntegrationTest : AndroidTestBase() {
    ...
    private fun performWelcomeStep() {
        composeTestRule.onNodeWithText("Welcome to LemonQwest")
            .assertIsDisplayed()
    ...
    private fun performCompletionStep() {
        ...
        composeTestRule.onNodeWithText("Start Using LemonQwest").performClick()
        composeTestRule.waitForIdle()
    }
    ...
    fun testChildManagementDuringOnboarding() = runTest {
        ...
        onboardingStateFlow.value = onboardingStateFlow.value.copy(
            children = listOf(
                com.lemonqwest.app.presentation.viewmodels.ChildProfile(
                    name = firstChildName,
    ...
    fun testOnboardingCompletionErrorHandling() = runTest {
        ...
        // Attempt completion
        composeTestRule.onNodeWithText("Start Using LemonQwest")
            .performClick()
