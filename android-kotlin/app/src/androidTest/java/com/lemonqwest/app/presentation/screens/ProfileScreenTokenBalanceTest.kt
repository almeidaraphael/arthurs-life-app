...
@HiltAndroidTest
class ProfileScreenTokenBalanceTest {
    @get:Rule(order = 0)
    ...
    fun profileScreen_displaysTokenBalance_forChildUser() {
        ...
        composeTestRule.onNodeWithText("Token Balance").assertIsDisplayed()
        composeTestRule.onNodeWithText("50 tokens").assertIsDisplayed()
        composeTestRule.onNodeWithContentDescription("Tokens").assertIsDisplayed()
    }
}
