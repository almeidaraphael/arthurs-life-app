...
/**
 * End-to-end integration tests for PIN authentication workflow with complete test isolation.
 *
 ...
 */
class PinAuthenticationEndToEndTest : AndroidTestBase() {
    ...
    fun testAuthenticationStatePersistence() = runTest {
        ...
        // Create test DataStore for this test
