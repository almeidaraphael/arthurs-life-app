...
class AuthRepositoryImplTest : ViewModelTestBase() {
    ...
    inner class PinAuthentication {
        ...
        fun shouldAuthenticateUserAndStoreSessionWhenPinMatches() = runViewModelTest {
            // Arrange
            val pin = "1234"
        ...
        fun shouldReturnInvalidPinWhenPinNotFoundInDataSource() = runViewModelTest {
            // Arrange
            val invalidPin = "9999"
        ...
        fun shouldHandleChildUserAuthenticationThroughRepository() = runViewModelTest {
            // Arrange
            val childPin = "5678"
        ...
        fun shouldHandleEmptyPinGracefully() = runViewModelTest {
            // Arrange
            val emptyPin = ""
    ...
    inner class RoleSwitching {
        ...
        fun shouldAllowCaregiverToSwitchToChildRole() = runViewModelTest {
            // Arrange
        ...
        fun shouldPreventChildFromSwitchingRoles() = runViewModelTest {
            // Arrange
        ...
        fun shouldReturnUserNotFoundWhenTargetRoleUserDoesNotExist() = runViewModelTest {
            // Arrange
            coEvery { authPreferencesDataStore.currentUserId } returns flowOf(testCaregiverUser.id)
            coEvery { userDataSource.findById(testCaregiverUser.id) } returns testCaregiverUser
        ...
        fun shouldReturnUserNotFoundWhenNoCurrentUserSessionExists() = runViewModelTest {
            // Arrange
        ...
        fun shouldReturnUserNotFoundWhenCurrentUserIdExistsButUserNotFound() = runViewModelTest {
            // Arrange
    ...
    inner class CurrentUserRetrieval {
        ...
        fun shouldRetrieveCurrentUserWhenSessionExists() = runViewModelTest {
            // Arrange
            coEvery { authPreferencesDataStore.currentUserId } returns flowOf(testCaregiverUser.id)
            coEvery { userDataSource.findById(testCaregiverUser.id) } returns testCaregiverUser
        ...
        fun shouldReturnNullWhenNoCurrentUserSession() = runViewModelTest {
            // Arrange
            coEvery { authPreferencesDataStore.currentUserId } returns flowOf(null)
        ...
        fun shouldReturnNullWhenUserIdExistsButUserNotFoundInDataSource() = runViewModelTest {
            // Arrange
        ...
        fun shouldHandleChildUserSessionRetrieval() = runViewModelTest {
            // Arrange
            coEvery { authPreferencesDataStore.currentUserId } returns flowOf(testChildUser.id)
            coEvery { userDataSource.findById(testChildUser.id) } returns testChildUser
    ...
    inner class LogoutOperations {
        ...
        fun shouldClearCurrentUserSessionOnLogout() = runViewModelTest {
            // Arrange
        ...
        fun shouldHandleLogoutWhenNoSessionExists() = runViewModelTest {
            // Arrange
            coEvery { authPreferencesDataStore.clearCurrentUser() } returns Unit
    ...
    inner class RepositoryIntegration {
        ...
        fun shouldCoordinateBetweenDataSourceAndPreferencesStore() = runViewModelTest {
            // Arrange
            val pin = "1234"
            coEvery { userDataSource.findByPin(pin) } returns testCaregiverUser
            coEvery { authPreferencesDataStore.setCurrentUser(any(), any()) } returns Unit
        ...
        fun shouldMaintainDataConsistencyAcrossOperations() = runViewModelTest {
    ...
    inner class ErrorHandlingAndEdgeCases {
        ...
        fun shouldHandleDataSourceExceptionsGracefully() = runViewModelTest {
            // Arrange
            val pin = "1234"
        ...
        fun shouldHandlePreferencesStoreExceptionsGracefully() = runViewModelTest {
            // Arrange
            val pin = "1234"
            coEvery { userDataSource.findByPin(pin) } returns testCaregiverUser
            coEvery {
        ...
        fun shouldHandleConcurrentAccessScenarios() = runViewModelTest {
            // Arrange
            val pin = "1234"
            coEvery { userDataSource.findByPin(pin) } returns testCaregiverUser
            coEvery { authPreferencesDataStore.setCurrentUser(any(), any()) } returns Unit
