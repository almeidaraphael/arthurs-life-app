...
class AuthenticationDomainServiceTest {
    ...
    fun setUp() {
        ...
        io.mockk.coEvery { userDataSource.findById(any()) } returns null
        io.mockk.coEvery { userDataSource.findByPin(any()) } returns null
        io.mockk.coEvery { userDataSource.findByRole(any()) } returns null
        io.mockk.coEvery { authPreferencesDataStore.setCurrentUser(any(), any()) } returns Unit
        io.mockk.coEvery { authPreferencesDataStore.clearCurrentUser() } returns Unit
        io.mockk.coEvery { authPreferencesDataStore.currentUserId } returns kotlinx.coroutines.flow.flowOf(null)
    }
