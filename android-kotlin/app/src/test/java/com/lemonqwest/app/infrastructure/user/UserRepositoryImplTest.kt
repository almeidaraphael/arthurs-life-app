 ...
 *
 * CATEGORY A TEST: Repository/Infrastructure test using standalone pattern.
 * Does not need ViewModel infrastructure, uses direct runTest with MockK setup.
 */
...
class UserRepositoryImplTest {
    ...
    @Test
    fun shouldFindUserByIdWhenExists() = runTest {
        // Given
        val userId = "user-1"
        val expectedUser = TestDataFactory.createChildUser(id = userId, name = "LemonQwest Kid")
    ...
    @Test
    fun shouldReturnNullWhenUserDoesNotExist() = runTest {
        // Given
    ...
    @Test
    fun shouldFindUserByRoleWhenExists() = runTest {
        // Given
        val role = UserRole.CHILD
        val expectedUser = TestDataFactory.createChildUser(name = "LemonQwest Kid")
    ...
    @Test
    fun shouldReturnNullWhenNoUserWithRoleExists() = runTest {
        // Given
    ...
    fun shouldGetAllUsers() = runTest {
        ...
        val expectedUsers = listOf(
            TestDataFactory.createChildUser(id = "child-1", name = "LemonQwest Kid"),
    ...
    @Test
    fun shouldReturnEmptyListWhenNoUsersExist() = runTest {
        // Given
    ...
    @Test
    fun shouldSaveUserWithPin() = runTest {
        // Given
    ...
    @Test
    fun shouldHandleMultipleUserSaves() = runTest {
        // Given
        val users = listOf(
            TestDataFactory.createChildUser(id = "child-1", name = "LemonQwest Kid"),
    ...
    @Test
    fun shouldUpdateExistingUser() = runTest {
        // Given
    ...
    @Test
    fun shouldUpdateUserPin() = runTest {
        // Given
        val originalUser = TestDataFactory.createCaregiverUser()
        val newPin = com.lemonqwest.app.domain.auth.PIN.create("5678")
    ...
    @Test
    fun shouldThrowExceptionWhenDeletingUser() = runTest {
        // Given
    ...
    @Test
    fun shouldNotCallDataSourceWhenDeleteAttempted() = runTest {
        // Given
        val userId = "user-to-delete"
    ...
    fun shouldPropagateDataSourceExceptions() = runTest {
        ...
        // When & Then
        val actualException = assertThrows<IllegalStateException> {
