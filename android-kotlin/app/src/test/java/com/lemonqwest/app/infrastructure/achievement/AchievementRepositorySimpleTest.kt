 ...
 * operations.
 *
 * CATEGORY A TEST: Infrastructure/repository layer test using standalone pattern.
 * No ViewModelTestBase needed as this tests infrastructure layer, not presentation ViewModels.
 */
