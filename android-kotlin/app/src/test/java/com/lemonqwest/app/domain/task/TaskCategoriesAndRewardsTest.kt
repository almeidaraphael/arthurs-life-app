...
/**
 * Focused test suite for Task categories and token rewards.
 *
 * Tests cover:
 * - Default reward assignment per category
 * - Personal care task category validation
 * - Household task category validation
 * - Homework task category validation
 * - Custom token reward handling
 */
