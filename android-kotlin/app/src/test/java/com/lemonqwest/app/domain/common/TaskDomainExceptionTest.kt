...
/**
 * Focused test suite for TaskDomainException functionality.
 *
 * Tests cover:
 * - Task domain exception creation with message
 * - Task domain exception creation with cause
 * - Task-specific error scenarios handling
 */
@OptIn(ExperimentalCoroutinesApi::class)
@DisplayName("TaskDomainException Tests")
class TaskDomainExceptionTest {
