...
import com.arthurslife.app.testutils.DatabaseAssertions
import com.arthurslife.app.testutils.DatabaseCleanup
import com.arthurslife.app.testutils.DatabaseTestFactory
import com.arthurslife.app.testutils.EntityTestFactory
...
class UserDaoTest {
    ...
    inner class CreateOperations {
        ...
        fun shouldInsertUser() = runTest {
            // Given
            val user = EntityTestFactory.createUserEntity(
                id = "user-1",
                name = "Arthur",
                role = UserRole.CHILD,
                tokenBalance = 25,
        ...
        fun shouldReplaceUserOnConflict() = runTest {
            // Given
            val originalUser = EntityTestFactory.createUserEntity(
                id = "user-1",
                name = "Original Name",
                tokenBalance = 10,
                role = UserRole.CHILD,
            )
            val updatedUser = EntityTestFactory.createUserEntity(
                id = "user-1",
                name = "Updated Name",
                tokenBalance = 20,
                role = UserRole.CHILD,
        ...
        fun shouldInsertMultipleUsers() = runTest {
            // Given
            val users = listOf(
                EntityTestFactory.createUserEntity(id = "user-1", name = "Arthur"),
                EntityTestFactory.createUserEntity(id = "user-2", name = "Emma"),
                EntityTestFactory.createUserEntity(
                    id = "caregiver-1",
                    name = "Parent",
                    role = UserRole.CAREGIVER,
                ),
    ...
    inner class DeleteOperations {
        ...
        fun shouldDeleteUserById() = runTest {
            // Given
            val user = EntityTestFactory.createUserEntity(id = "user-1")
            userDao.insertUser(user)
        ...
        fun shouldDeleteOnlySpecifiedUser() = runTest {
            // Given
            val users = listOf(
                EntityTestFactory.createUserEntity(id = "user-1"),
                EntityTestFactory.createUserEntity(id = "user-2"),
                EntityTestFactory.createUserEntity(id = "user-3"),
            )
            users.forEach { userDao.insertUser(it) }
    ...
    inner class DataIntegrity {
        ...
        fun shouldPreserveAllUserFields() = runTest {
            ...
            val user = UserEntity(
                id = "test-user",
                name = "Test User",
                role = UserRole.CHILD.name, // FIX: use .name to pass String
                tokenBalance = 42,
                pinHash = null,
    ...
    inner class DomainConversion {
        ...
        fun shouldConvertToDomainModel() = runTest {
            // Given
            val userEntity = EntityTestFactory.createUserEntity(
                id = "test-user",
                name = "Test User",
                role = UserRole.CHILD,
                tokenBalance = 25,
        ...
        fun shouldConvertFromDomainModel() = runTest {
            // Given
            val domainUser = com.arthurslife.app.domain.TestDataFactory.createChildUser(
                id = "domain-user",
                name = "Domain User",
                tokenBalance = com.arthurslife.app.domain.user.TokenBalance.create(30),
            )
